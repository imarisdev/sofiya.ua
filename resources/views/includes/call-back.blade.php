<div id="form-call-back" class="cell js-form-closed" >
    ...
    <form id="f_contact" class="js-feedback-form" name="contact" onsubmit="yaCounter27077372.reachGoal('callBack'); ga('send', 'event', 'callBack', 'callBackForm')">
        ...
        <label class="m_b-5 cell m_t-0" for="">Коментарий:</label><br>

        <textarea placeholder="Введите Ваше сообщение" name="content" class="field m_b-20"></textarea>
        <div class="text-center">
            <button class="blue-btn m_b-10" id="send">ЗАКАЗАТЬ</button>
        </div>
    </form>
</div>
