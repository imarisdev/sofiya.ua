...
@section('content')
    <section class="content">
        <form role="form" id="pageedit" class="js-admin-form-save" action="/admin/seo/save" data-edit="/admin/seo/edit" method="POST">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-10">
                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="object_type" class="form-control js-object_type-select">
                                                @foreach($types as $tkey => $type)
                                                    <option value="{{ $type->object_type }}">{{ $type->object_type }}</option>
                                                @endforeach
                                            </select>
