...
@section('content')
    <section class="content">
        <form role="form" id="pageedit" class="js-admin-form-save" action="/admin/complex/update" data-edit="/admin/complex/edit" method="POST">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-10">
                    <div class="row">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_2">
                                ...
                                <div class="form-group callout callout-info">
                                    @if(!empty($complex->image_big))
                                        <img src="{{ Helpers::getImage($complex->image_big) }}" alt="..." class="margin">
                                    @endif
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group callout callout-info">
                                    @if(!empty($complex->image_small))
                                        <img src="{{ Helpers::getImage($complex->image_small) }}" alt="..." class="margin">
                                    @endif
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane" id="tab_3">
                                @include('admin.forms.seo', ['item_id' => $complex->id, 'item_type' => 'complex', 'item' => $seo])
                            </div>
                        </div>
                    </div>
                </div>
