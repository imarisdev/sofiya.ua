                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            @if(!empty($flat->house_id))
                                                {!! Form::select('house_id', $houses, $flat->house_id, ['class' => 'form-control']) !!}
                                            @else
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            @if(!empty($flat->plan_id))
                                                {!! Form::select('plan_id', [], $flat->plan_id, ['class' => 'form-control']) !!}
                                            @else
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="flor" name="flor" placeholder="Этаж"
                                                   value="{{ $flat->flor or '' }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
