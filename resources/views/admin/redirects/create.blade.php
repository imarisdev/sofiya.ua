...
@section('content')
    <section class="content">
        <form role="form" id="pageedit" class="js-admin-form-save" action="/admin/redirects/save" data-edit="/admin/redirects/edit" method="POST">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-8">
                            <h2 class="page-header">{{ $redirect->title or '' }}</h2>
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('code', [301 => 301, 302 => 302], null, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
