...
@section('content')
    <section class="content">
        <form role="form" id="pageedit" class="js-admin-form-save" action="/admin/menu/rebuild" data-edit="/admin/menu/edit" method="POST">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-8">
                            <h2 class="page-header">{{ $menu_type or '' }}</h2>
                        </div>
                    </div>
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="js-sortable-menu admin-sortable-menu">
                                            @each('admin.menu.items', $menu, 'item')
                                        </ul>
                                    </div>
                                </div>
                            </div>
