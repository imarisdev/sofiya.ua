...
<div class="table table-border">
    ...
    @foreach($info as $key => $item)
        <div class="table-row">
            ...
            <div class="table-cell">
                <a class="js-fancybox" href="#fancybox-house-{{ $item->rooms . $item->id }}" data-href="/planirovki/{{ $plan['info']['slug'] }}/{{ $item->link() }}">
                    <img alt="ЖК София" src="{{ Helpers::getImage($item->image, '0x70') }}" />
                </a>

                <div id="fancybox-house-{{ $item->rooms . $item->id }}" class="text-center fancybox-house d_n">
                    <div class="cell">
