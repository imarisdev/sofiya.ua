...
<div class="cell rewiev-item">
    <div class="rewiev-title cell">
        ...
        <div class="cell10">
            ...
            <div class="cell info">
                <div class="fl_l m_r-20">16 января 2016</div>

                <div class="fl_l m_r-20">12:52</div>

                <div class="fl_l m_r-20"><i class="icon-heart"></i>11</div>
            </div>
        </div>

        <div class="cell2 like">
            <div class="fl_r text-center">
                <a href="javascript:;" class="icon-like"></a>
                <p>Нравится</p>
            </div>
        </div>
    </div>
...
<div class="cell m_b-30">
    <div class="text-center">
        <a href="#" class="btn-gray">Еще отзывы</a>
    </div>
</div>
