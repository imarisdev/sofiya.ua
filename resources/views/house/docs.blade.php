...
<div class="cell m_b-30 m_t-10">
    <div class="cell4">
        <a href="/img/act/akt_na_zemlu.jpg" class="under-link black js-fancybox">
            <img class="p_r-15" src="/img/pdf.png" alt="Акт на землю">Акт на землю
        </a>
    </div>

    <div class="cell4">
        <a href="/img/act/razreshenie.jpg" class="under-link black js-fancybox">
            <img class="p_r-15" src="/img/pdf.png" alt="Разрешение на строительство">Разрешение на строительство
        </a>
    </div>
